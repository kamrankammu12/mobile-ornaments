...
@WebServlet("/admins/examples/delete")
public class delete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(rs>0){
                ses.setAttribute("del_prod_succmsg","Product deleted successfully...!");
                response.sendRedirect(response.encodeRedirectURL("stock.jsp"));
            }
            else{
                ses.setAttribute("del_prod_errmsg","Request failed to delete the product....!");
                response.sendRedirect(response.encodeRedirectURL("stock.jsp"));
            }
        }catch(Exception e){
            e.printStackTrace();
