...
<body class="bg-default">
  ...
  <div class="main-content">
    <!-- Header -->
    <div class="header bg-gradient-primary py-5 py-lg-10 pt-lg-5">
      <div class="container">
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">User Sign Up</h1>
          ...
          <div class="card bg-secondary border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="Register" method="POST">
                ...
                Already have an account ? <a href="user_login.jsp"> Login </a><br>
                 <div class="dropdown show">
  <a class="btn btn-secondary dropdown-toggle ml-10" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Choose
  </a>

  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" href="user_signup.jsp">User Rigister</a>
    <a class="dropdown-item" href="admin.jsp">Admin Rigister</a>
   
  </div>
</div>
                <div class="text-center">
                  <button type="submit" name="submit" class="btn btn-primary mt-3">Create account</button>
                </div>
              </form>
