...
<%
    ...
    Object ob2=session.getAttribute("del_prod_succmsg");
    if(ob2!=null)
        str2=ob2.toString();
%>
<!DOCTYPE html>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="stock.jsp"  style="background-color: aliceblue">
      ...
      <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center  ml-md-auto ">
            ...
            </li><p style="position: 2px;color:yellow;font-size:18px;margin: 20px">Welcome :  
                <%
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                 ...
                 <%    
                  ...
                  out.println("<tr><td><span class='status'>" +rs.getInt(1)+ "</span></td>");
                  out.println("<td scope='row'><div class='media align-items-center'><div class='media-body'><span class='name mb-0 text-sm' >"+rs.getString(2)+"</span></div></div></td>");
